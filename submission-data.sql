...
(10, NULL, 'Member Garden - Kowalski', 'private garden', 'Saginaw MI');
...
(1, 1, 4, 1, 1, '2024-03-10', 50, 50),
(2, 3, 4, 3, 6, '2024-04-02', 100, 100),
(3, 2, 4, 6, 2, '2024-04-15', 75, 75),
(4, 1, 5, 11, 1, '2024-07-01', 30, 30),
(5, 6, 4, 6, 7, '2024-08-05', 200, 200),
(6, 7, 4, 4, 6, '2024-03-25', 150, 150),
(7, 10, 4, 20, 10, '2024-07-20', 10, 10),
(8, 2, 4, 17, 2, '2024-05-10', 80, 80),
(9, 1, 5, 2, 1, '2024-06-03', 70, 70),
(10, 4, 4, 9, NULL, '2024-08-22', 25, 25);
...
(1, 1, 5, 3.0, '2024-04-05', 'Seed cleaning'),
(2, 2, 5, 2.5, '2024-04-05', 'Seed cleaning'),
(3, 6, 3, 4.0, '2024-05-18', 'Prairie restoration planting'),
(4, 1, 4, 1.5, '2024-06-10', 'Inventory update'),
(5, 3, 4, 2.0, '2024-03-22', 'Packet assembly'),
(6, 7, 6, 3.5, '2024-07-03', 'Field collection - Bergamot'),
(7, 10, 10, 5.0, '2024-08-18', 'Field collection - Indiangrass'),
(8, 2, 2, 2.0, '2024-09-28', 'Harvest processing'),
(9, 6, 2, 1.0, '2024-09-28', 'Harvest processing'),
(10, 1, 4, 3.0, '2024-10-05', 'Species data entry');
